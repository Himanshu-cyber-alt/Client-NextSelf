...
export default function RoyalReward() {
  ...
  const REWARDS = [
    { duration: 10/60, rarity: "common", chance: 50, video: "/30.mp4" },
    { duration: 10/60, rarity: "rare", chance: 35, video: "/45.mp4" },
    { duration: 10/60, rarity: "legendary", chance: 15, video: "/60.mp4" },
  ];
